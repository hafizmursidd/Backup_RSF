...
{
    public class LMM06000Cls : R_BusinessObject<LMM06000BillingRuleDTO>
    {
        protected override LMM06000BillingRuleDTO R_Display(LMM06000BillingRuleDTO poEntity)
        {
            R_Exception loEexception = new R_Exception();
            LMM06000BillingRuleDTO loReturn = null;
            R_Db loDb;
            try
            {
                ...
                loReturn = R_Utility.R_ConvertTo<LMM06000BillingRuleDTO>(loReturnTemp).ToList().FirstOrDefault();
            }
            catch (Exception ex)
            {
                loEexception.Add(ex);
        ...
        protected override void R_Saving(LMM06000BillingRuleDTO poNewEntity, eCRUDMode poCRUDMode)
        {
        ...
        protected override void R_Deleting(LMM06000BillingRuleDTO poEntity)
        {
