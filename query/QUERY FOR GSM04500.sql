...
EXEC RSP_GS_GET_JOURNAL_GRP_GOA_LIST 'RCD', 'jbmpc', '10' , 'Z', 'hmc'
...
VALUES						('RCD', 'JBMPC', '10','A','AP','1','12.10.0000','HMC')
...
VALUES						('RCD', 'JBMPC', '10','A','ARDEP','RSF','12.50.0000','HMC')
...
---RSP_GS_GET_JOURNAL_GRP_GOA_DETAIL @CCOMPANY_ID,  @CPROPERTY_ID, @CJOURNAL_GROUP_TYP,  @CJOURNAL_GROUP_CODE, @CGOA_CODE , @CUSER_LOGIN_ID
EXEC RSP_GS_GET_JOURNAL_GRP_GOA_LIST  'RCD', 'jbmpc', '10' , 'A', 'hmc'
