...
EXEC RSP_GS_GET_JOURNAL_GRP_GOA_DEPT_LIST 'rcd', 'jbmpc', '10', 'Z', 'AP', 'HMC'
...
INSERT INTO GSM_JRNGRP_GOA (CCOMPANY_ID, CPROPERTY_ID, CJRNGRP_TYPE, CJRNGRP_CODE, CGOA_CODE, LDEPARTMENT_MODE, CGLACCOUNT_NO, CCREATE_BY)
VALUES						('RCD', 'JBMPC', '12','A','ARDEP','1','12.50.0000','HMC')
...
EXEC RSP_GS_MAINTAIN_JOURNAL_GROUP_ACCOUNT_DEPT  'RCD','JBMPC', '12', 'A', 'ARDEP','ACC','12.50.0000' ,'ADD', 'hmc'
EXEC RSP_GS_MAINTAIN_JOURNAL_GROUP_ACCOUNT_DEPT  'RCD','JBMPC', '12', 'A', 'AP','RSF','12.50.0000' ,'ADD', 'hmc'

EXEC RSP_GS_GET_JOURNAL_GRP_GOA_LIST 'RCD', 'jbmpc', '11' , 'A', 'hmc'
EXEC RSP_GS_GET_JOURNAL_GRP_GOA_LIST 'RCD', 'jbmpc', '12' , 'A', 'hmc'
